      ...
      <div class="card">
        <div class="card-body pt-3">
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              <label for="rank" class="col-md-2 col-lg-2 col-form-label">Rank</label>
              <div class="col-md-10 col-lg-10">
                <select name="rank" class="form-control" id="rank" required>
                  <option value="" selected>Select Rank</option>
                  <?php for($i=1;$i<=20;$i++){?>
                    <option value="<?=$i?>" <?=(($rank == $i)?'selected':'')?>>Rank <?=$i?></option>
                  <?php }?>
                </select>
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-md-10 col-lg-10">
                ...
                <?php if($image != ''){?>
                  <img src="<?=env('UPLOADS_URL').'how_it_work/'.$image?>" class="img-thumbnail" alt="<?=$title?>" style="width: 150px; height: 150px; margin-top: 10px;">
                <?php } else {?>

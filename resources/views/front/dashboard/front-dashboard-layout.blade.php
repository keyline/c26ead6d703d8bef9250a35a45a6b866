...
<body>
    ...
    <script type="text/javascript">
        $(function() {
            var top = $('#sidebar-nav').offset().top - parseFloat($('#sidebar-nav').css('marginTop').replace(/auto/,
                0));
...
<script>
    ...
    const handleAddSlot = (e) => {
            ...
            const handleDurationChange = (e) => {
                ...
                // Check if the select element is in the first child of its parent
                var isFirstChild = is1st = parentDiv.is(':first-child');
                // alert(">>" + isFirstChild);

                // Log the result to the console (for demonstration purposes)
                // console.log("Is the select element in the first child?", isFirstChild);
            }
            ...
            function handleChangeTimeFrom(e) {
                ...
                function handleChangeTimeFrom(e) {
                    ...
                    updateOnChangeInput(postData).then((data) => {
                        parentEl = $(e.target).closest('div.slots-select-box');
                        $(parentEl).html('<div class="slots_section_parent slots-select-box">' + data.html +
                            '</div>');
                        $('.select2-frm').select2();
...
<form action="#" method="POST" id="demo-form">
    <button class="g-recaptcha" data-sitekey="6LfEu0opAAAAAIP82Q9XnG0dYN81-_DteAszQFMN" data-callback="onSubmit"

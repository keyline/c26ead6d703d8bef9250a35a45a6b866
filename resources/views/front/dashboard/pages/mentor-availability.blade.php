                                            ...
                                            <div class="slot_weeksday">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="flexCheckChecked_{{ $loop->index }}">
                                                        {{ $day->day_text }}
                                                    </label>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="slots-select-box">
                                                            ...
                                                            <select class="select2-frm"
                                                                ...
                                                                @foreach ($slot_dropdown as $option)
                                                                    <option value="<?= $option['value'] ?>"
                                                                        <?= $option['value'] == $avail_from ? 'selected' : '' ?>>
                                                                        <?= $option['name'] ?></option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="slot__duration">
                                                            <select class="select__slot__duration"
                                                                ...
                                                                style="width: 50%">
                                                                <option value="30"
                                                                    <?= $mentorAvlDaywise->duration == 30 ? 'selected' : '' ?>>
                                                                    30 minutes</option>
                                                                <option value="60"
                                                                    <?= $mentorAvlDaywise->duration == 60 ? 'selected' : '' ?>>
                                                                    60 minutes</option>
                                                            </select>
                                                        </div>
                                                        <div style="display: inline; margin: 0px 0.2em;">-</div>
                                                        ...
                                                        <div class="no__of__slots">
                                                            ...
                                                            <select class="select__no__ofslot"
                                                                ...
                                                                style="width: 50%">
                                                                <option value="1"
                                                                    <?= $mentorAvlDaywise->no_of_slot == 1 ? 'selected' : '' ?>>
                                                                    x 1 slot</option>
                                                                <option value="2"
                                                                    <?= $mentorAvlDaywise->no_of_slot == 2 ? 'selected' : '' ?>>
                                                                    x 2 slots</option>
                                                                <option value="3"
                                                                    <?= $mentorAvlDaywise->no_of_slot == 3 ? 'selected' : '' ?>>
                                                                    x 3 slots</option>
                                                                <option value="4"
                                                                    <?= $mentorAvlDaywise->no_of_slot == 4 ? 'selected' : '' ?>>
                                                                    x 4 slots</option>
                                                                <option value="5"
                                                                    <?= $mentorAvlDaywise->no_of_slot == 5 ? 'selected' : '' ?>>
                                                                    x 5 slots</option>
                                                                <option value="6"
                                                                    <?= $mentorAvlDaywise->no_of_slot == 6 ? 'selected' : '' ?>>
                                                                    x 6 slots</option>
                                                                <option value="7"
                                                                    <?= $mentorAvlDaywise->no_of_slot == 7 ? 'selected' : '' ?>>
                                                                    x 7 slots</option>
                                                                <option value="8"
                                                                    <?= $mentorAvlDaywise->no_of_slot == 8 ? 'selected' : '' ?>>
                                                                    x 8 slots</option>
                                                                <option value="9"
                                                                    <?= $mentorAvlDaywise->no_of_slot == 9 ? 'selected' : '' ?>>
                                                                    x 9 slots</option>
                                                                <option value="10"
                                                                    <?= $mentorAvlDaywise->no_of_slot == 10 ? 'selected' : '' ?>>
                                                                    x 10 slots</option>
                                                                <option value="11"
                                                                    <?= $mentorAvlDaywise->no_of_slot == 11 ? 'selected' : '' ?>>
                                                                    x 11 slots</option>
                                                            </select>
                                                        </div>
                                                        <div style="display: inline; margin: 0px 0.2em;">-</div>
                                                        <div class="slot_endtime">
                                                            <input type="text" class="slot__endtime__txt"
                                                                ...
                                                                value="<?= $avail_to ?>" readonly="readonly">
                                                        </div>

              ...
              <div>
                  ...
                  <table style="width: 100%;  border-spacing: 2px;">
                      <tbody>
                          ...
                          <tr>
                              <th style="background: #cccccc42; color: #000; width: 30%; padding: 10px; text-align: left; font-family: sans-serif; font-size: 14px;">Survey Link</th>
                              <td style="padding: 10px; background: #cccccc42; text-align: left; color: #000;font-family: sans-serif;font-size: 15px;"><a href="<?=url('user/survey-list')?>" style="background: #f9233f; color: #fff; padding: 8px 13px; border-radius: 5px; text-decoration: none;">Take Free test Now</a></td>
                          </tr>
                      </tbody>
                  </table>
              </div>

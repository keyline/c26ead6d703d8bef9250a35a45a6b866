...
<html lang="en">
   ...
   <body>
      ...
      <?php }?>
      <?php if(($pageName == 'how-it-works') || ($pageName == 'signin') || ($pageName == 'forgot-password') || ($pageName == 'validate-otp/{id}') || ($pageName == 'reset-password/{id}') || ($pageName == 'student-signup') || ($pageName == 'mentor-signup') || ($pageName == 'mentor-signup-2') || ($pageName == 'mentor-signup-3') || ($pageName == 'mentor-signup-4') || ($pageName == 'team-member-profile/{id}')){?>

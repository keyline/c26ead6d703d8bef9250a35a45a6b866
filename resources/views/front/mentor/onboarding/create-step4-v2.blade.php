                ...
                <div class="col-lg-7 col-md-8 col-sm-8">
                    <div class="metor_dashboard">
                        <div class="metor_information">
                            ...
                            <p class="text-muted mb-4">Let your audience know when you're available. You can edit this later
                            </p>
                            ...
                            <div class="metor_step1_form">
                                ...
                                @endif
                                <form action="{{ route('mentor.create.step4') }}" method="POST" accept-charset="utf-8"
                                    ...
                                    <div class="ant-col ant-col-24 add-slots mentoe_admin_section">
                                        <div class="row slot-item hide_tabmobile">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                    <div class="col-md-3 text-center"><span class="fw-bold"
                                                            style="color: #f9233f;">Start</span></div>
                                                    <div class="col-md-3 text-center"><span class="fw-bold"
                                                            style="color: #f9233f;">Duration</span></div>
                                                    <div class="col-md-3 text-center"><span class="fw-bold"
                                                            style="color: #f9233f;">No. Of Slots</span></div>
                                                    <div class="col-md-3 text-left"><span class="fw-bold"
                                                            style="color: #f9233f;">End</span></div>
                                                </div>
                                            </div>
                                        </div>
                                        @foreach ($days as $day)
                                            <div class="row slot-item">
                                                <div class="col-md-3">
                                                    <div class="slot_weeksday">
                                                        <div class="form-check">
                                                            <input class="form-check-input chk__slots__show__hide"
                                                                type="checkbox" name="day_of_week[{{ $day->id }}]"
                                                                value="{{ $day->day }}"
                                                                data-chkcontainer="{{ strtolower($day->day_text) }}"
                                                ...
                                                <div class="col-md-9 slots__parent">
                                                        ...
                                                        <div class="slots-section">
                                                            <div class="slots-select-box">
                                                                <div class="slot_starttime">
                                                                    <select class="select2-frm"
                                                                        name="availability[from][{{ $day->id }}][]">
                                                                ...
                                                                <div class="slot__duration">
                                                                    <select class="select__slot__duration"
                                                                        name="duration[{{ $day->id }}][]"
                                                                        style="width: 50%">
                                                                    </select>
                                                                </div>
                                                                <div style="display: inline; margin: 0px 0.2em;">-</div>
                                                                ...
                                                                <button class="add-slot-btn add__slot__parent"
                                                                    data-container="{{ strtolower($day->day_text) }}">
                                                                    <span style="pointer-events: none;"><i
                                                    ...
                                                    @endif
                                                    <div class="slot__items__component"
                                                        id="item-list-container-{{ strtolower($day->day_text) }}">
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="form-group mt-1 pt5">
                                        <select class="docoument_selet form-select" name="document_head"
                                            id="document_head">
                                    ...
                                    @foreach ($documents as $document)
                                        <div class="form-group pt-1 hide"
                                            id="{{ strtolower(str_replace(' ', '_', $document->id)) }}">
                                            <label>{{ $document->document }}</label>
                                            <label><small>Max 1 mb in size and supported format
                                                    (Jpg/Jpeg/pdf)</small></label>
                                            <input type="file" class="form-control"
                                                name="docs_attachment[{{ $document->document }}]">
                                        </div>
                                    @endforeach
            ...
            if (e.target.classList.contains('add__slot__parent')) {
                ...
                addSelectInput(postData).then((data) => {
                    ...
                    parent.insertAdjacentHTML('afterend',
                        '<div class="slots_section_parent slots-select-box">' + data.html + '</div>');
                    //parent.after(wrapEl);
        ...
        const handleAddSlotFrmChkBtn = (e) => {
            ...
            if (e.target.checked) {
                ...
                addSelectInput(postData).then((data) => {
                    ...
                    iDiv.insertAdjacentHTML('afterbegin',
                        '<div class="slots_section_parent slots-select-box">' + data.html + '</div>');
                    initializeDurationSelect2(duration);
                    initializeSlotNumberSelect2(noofslot);
                ...
                if (!d) {
                    ...
                    if (Object.keys(nestedElements).length === 0) {
                        ...
                        console.log({
                            'unavailableDiv': iDivUnavailable
                        });

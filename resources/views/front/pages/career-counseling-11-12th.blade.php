...
<div class="inner_slider_section">
   <div class="container-fluid px-0">
      <div class="innerpage_banner">
         <div class="innerbanner_img"><img src="<?=env('FRONT_ASSETS_URL')?>assets/images/career-counseling-11-12th-banner.jpg" alt="banner"></div>
         <div class="innerbanner_bredcum">
            <h1>Career Counseling 11-12th</h1>
            <ul>
               <li><a href="<?=url('/')?>">Home</a></li>
               <li>/</li>
               <li>Career Counseling 11-12th</li>
            </ul>
         </div>
      </div>
   </div>
...
<section class="static_section">
   <div class="container">
      <div class="row">
         ...
         <div class="col-lg-12">
            <p class="text-center">Choose from a number of experienced mentors below and book counseling sessions in 2 clicks to start making the right decisions right after 11-12th.</p>
         </div>
      </div>  
      <div class="row my-5">
         <div class="col-md-12">

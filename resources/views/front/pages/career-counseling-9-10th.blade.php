...
<section class="static_section">
   <div class="container">
      <div class="row">
         ...
         <div class="col-lg-12">
            <p class="text-center">Start making the right decisions right from the career onset journey from high school by booking counseling sessions with experienced mentors listed below in a couple of clicks.</p>
         </div>
      </div>  
      <div class="row my-5">
         <div class="col-md-12">

...
<section class="static_section">
   <div class="container">
      <div class="row">
         ...
         <div class="col-lg-12">
            <p class="text-center">Don't wait and stress over 12th boards preparation, ace your exams by booking board counseling sessions from the list of expert mentors below!</p>
         </div>
      </div>  
      <div class="row ">
         <div class="col-md-12">
